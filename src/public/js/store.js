...
async function publicar() {
  ...
  // Armamos el formulario con text y files: 
  ...
  // Como el custom error esta luego del multer de imgs, hacemos una validación primero en el front:
...
// Función para mostrar los productos del usuario: 
async function ownerProduct() {
  ...
  if (sessionRes.status === 401) {
    ...
    if (sessionRes) {
      ...
      // Obtenemos los productos de los premium o el admin:
      ...
      if (ownerProductRes.status === 401) {
        ...
        if (statusCodeRes === 200) {
          ...
          // Buscamos los productos del owner:
          ...
          // Table para la sección de productos del usuario o el admin:
